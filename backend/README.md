...
## Project Structure
    ...
    ├── tst_tc2125_fbwtygbo_88916  # Django project configurations
...
1. Clone this repo and `cd tst_tc2125_fbwtygbo_88916`
...
2. Clone this repo and `cd tst_tc2125_fbwtygbo_88916`
